  ...
  function countDown() {
    ...
    var countDown = new Date(xPdate).getTime(),
      x = setInterval(function() {
        ...
        if (cDays) {
          ((document.getElementById("days").innerText = addZero(
            Math.floor(distance / day)
          )),
          (document.getElementById("hours").innerText = addZero(
            Math.floor((distance % day) / hour),
            2
          ))),
            (document.getElementById("minutes").innerText = addZero(
              Math.floor((distance % hour) / minute),
              2
            )),
            (document.getElementById("seconds").innerText = addZero(
